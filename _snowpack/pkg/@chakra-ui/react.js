...
var sizes$l = _extends$e({}, spacing, largeSizes, {
  container
});
...
function filledStyle(props) {
  ...
  return _extends$9({}, addStripe && stripeStyle, isIndeterminate ? {
    bgImage: gradient
  } : {
    bgColor
  });
...
var Spinner = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  var _omitThemingProps = omitThemingProps(props),
    ...
    className
      ...
      rest = _objectWithoutPropertiesLoose$1(_omitThemingProps, ["label", "thickness", "speed", "color", "emptyColor", "className"]);
